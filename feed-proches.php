...
$nextbirthday = get_next_birthday($donnees['datedenaissance']);
       ...
       ?>
        ...
        <?php echo '<p ><i class="fa fa-clock-o" aria-hidden="true"></i> Dans ', floor((strtotime($nextbirthday) - time())/86400)+1; echo " jours</p>"; ?><a href="fiche-proche.php?idproche=<?php echo $donnees['ID'] ?>" class="btn btn-default btn-xs">Ajouter / voir vos idées cadeaux</a>
